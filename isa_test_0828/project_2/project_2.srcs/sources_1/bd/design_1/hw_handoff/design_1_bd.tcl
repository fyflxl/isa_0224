...
proc create_root_design { parentCell } {
  ...
  set dir_isa_in_1 [ create_bd_port -dir O dir_isa_in_1 ]
  set dir_isa_out [ create_bd_port -dir O dir_isa_out ]
  set dir_isa_out_1 [ create_bd_port -dir O dir_isa_out_1 ]
  set dir_isa_sa1 [ create_bd_port -dir O dir_isa_sa1 ]
  set dir_isa_sa1_1 [ create_bd_port -dir O dir_isa_sa1_1 ]
  set dir_isa_sa2 [ create_bd_port -dir O dir_isa_sa2 ]
  set dir_isa_sa2_1 [ create_bd_port -dir O dir_isa_sa2_1 ]
  set dir_isa_sd1 [ create_bd_port -dir O dir_isa_sd1 ]
  set dir_isa_sd1_1 [ create_bd_port -dir O dir_isa_sd1_1 ]
  set dir_isa_sd2 [ create_bd_port -dir O dir_isa_sd2 ]
  set dir_isa_sd2_1 [ create_bd_port -dir O dir_isa_sd2_1 ]
  set iocs16 [ create_bd_port -dir I iocs16 ]
  set iocs16_1 [ create_bd_port -dir I iocs16_1 ]
  set irq5 [ create_bd_port -dir I irq5 ]
  set irq5_1 [ create_bd_port -dir I irq5_1 ]
  set isa_aen [ create_bd_port -dir O isa_aen ]
  set isa_aen_1 [ create_bd_port -dir O isa_aen_1 ]
  set isa_ior [ create_bd_port -dir O isa_ior ]
  set isa_ior_1 [ create_bd_port -dir O isa_ior_1 ]
  set isa_iow [ create_bd_port -dir O isa_iow ]
  set isa_iow_1 [ create_bd_port -dir O isa_iow_1 ]
  set isa_rst_drv [ create_bd_port -dir O isa_rst_drv ]
  set isa_rst_drv_1 [ create_bd_port -dir O isa_rst_drv_1 ]
  set isa_sa [ create_bd_port -dir O -from 15 -to 0 isa_sa ]
  set isa_sa_1 [ create_bd_port -dir O -from 15 -to 0 isa_sa_1 ]
  set isa_sd_in [ create_bd_port -dir I -from 15 -to 0 isa_sd_in ]
  set isa_sd_in_1 [ create_bd_port -dir I -from 15 -to 0 isa_sd_in_1 ]
  set isa_sd_out [ create_bd_port -dir O -from 15 -to 0 isa_sd_out ]
  set isa_sd_out_1 [ create_bd_port -dir O -from 15 -to 0 isa_sd_out_1 ]
  set isa_tri_en [ create_bd_port -dir O isa_tri_en ]
  set isa_tri_en_1 [ create_bd_port -dir O isa_tri_en_1 ]
  set oe_isa_in [ create_bd_port -dir O oe_isa_in ]
  set oe_isa_in_1 [ create_bd_port -dir O oe_isa_in_1 ]
  set oe_isa_out [ create_bd_port -dir O oe_isa_out ]
  set oe_isa_out_1 [ create_bd_port -dir O oe_isa_out_1 ]
  set oe_isa_sa1 [ create_bd_port -dir O oe_isa_sa1 ]
  set oe_isa_sa1_1 [ create_bd_port -dir O oe_isa_sa1_1 ]
  set oe_isa_sa2 [ create_bd_port -dir O oe_isa_sa2 ]
  set oe_isa_sa2_1 [ create_bd_port -dir O oe_isa_sa2_1 ]
  set oe_isa_sd1 [ create_bd_port -dir O oe_isa_sd1 ]
  set oe_isa_sd1_1 [ create_bd_port -dir O oe_isa_sd1_1 ]
  set oe_isa_sd2 [ create_bd_port -dir O oe_isa_sd2 ]
  set oe_isa_sd2_1 [ create_bd_port -dir O oe_isa_sd2_1 ]
  ...
  # Create instance: rst_ps_0_50M, and set properties
  set rst_ps_0_50M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_0_50M ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph_1/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M00_AXI [get_bd_intf_pins axi_isa_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph_1/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M01_AXI [get_bd_intf_pins axi_isa_1/s00_axi] [get_bd_intf_pins ps7_0_axi_periph_1/M01_AXI]
  ...
  connect_bd_net -net axi_isa_1_dir_isa_in [get_bd_ports dir_isa_in_1] [get_bd_pins axi_isa_1/dir_isa_in]
  connect_bd_net -net axi_isa_1_dir_isa_out [get_bd_ports dir_isa_out_1] [get_bd_pins axi_isa_1/dir_isa_out]
  connect_bd_net -net axi_isa_1_dir_isa_sa1 [get_bd_ports dir_isa_sa1_1] [get_bd_pins axi_isa_1/dir_isa_sa1]
  connect_bd_net -net axi_isa_1_dir_isa_sa2 [get_bd_ports dir_isa_sa2_1] [get_bd_pins axi_isa_1/dir_isa_sa2]
  connect_bd_net -net axi_isa_1_dir_isa_sd1 [get_bd_ports dir_isa_sd1_1] [get_bd_pins axi_isa_1/dir_isa_sd1]
  connect_bd_net -net axi_isa_1_dir_isa_sd2 [get_bd_ports dir_isa_sd2_1] [get_bd_pins axi_isa_1/dir_isa_sd2]
  connect_bd_net -net axi_isa_1_irq [get_bd_pins axi_isa_1/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_isa_1_isa_aen [get_bd_ports isa_aen_1] [get_bd_pins axi_isa_1/isa_aen]
  connect_bd_net -net axi_isa_1_isa_ior [get_bd_ports isa_ior_1] [get_bd_pins axi_isa_1/isa_ior]
  connect_bd_net -net axi_isa_1_isa_iow [get_bd_ports isa_iow_1] [get_bd_pins axi_isa_1/isa_iow]
  connect_bd_net -net axi_isa_1_isa_rst_drv [get_bd_ports isa_rst_drv_1] [get_bd_pins axi_isa_1/isa_rst_drv]
  connect_bd_net -net axi_isa_1_isa_sa [get_bd_ports isa_sa_1] [get_bd_pins axi_isa_1/isa_sa]
  connect_bd_net -net axi_isa_1_isa_sd_out [get_bd_ports isa_sd_out_1] [get_bd_pins axi_isa_1/isa_sd_out]
  connect_bd_net -net axi_isa_1_isa_tri_en [get_bd_ports isa_tri_en_1] [get_bd_pins axi_isa_1/isa_tri_en]
  connect_bd_net -net axi_isa_1_oe_isa_in [get_bd_ports oe_isa_in_1] [get_bd_pins axi_isa_1/oe_isa_in]
  connect_bd_net -net axi_isa_1_oe_isa_out [get_bd_ports oe_isa_out_1] [get_bd_pins axi_isa_1/oe_isa_out]
  connect_bd_net -net axi_isa_1_oe_isa_sa1 [get_bd_ports oe_isa_sa1_1] [get_bd_pins axi_isa_1/oe_isa_sa1]
  connect_bd_net -net axi_isa_1_oe_isa_sa2 [get_bd_ports oe_isa_sa2_1] [get_bd_pins axi_isa_1/oe_isa_sa2]
  connect_bd_net -net axi_isa_1_oe_isa_sd1 [get_bd_ports oe_isa_sd1_1] [get_bd_pins axi_isa_1/oe_isa_sd1]
  connect_bd_net -net axi_isa_1_oe_isa_sd2 [get_bd_ports oe_isa_sd2_1] [get_bd_pins axi_isa_1/oe_isa_sd2]
  ...
  connect_bd_net -net iocs16_0_1 [get_bd_ports iocs16] [get_bd_pins axi_isa_0/iocs16]
  connect_bd_net -net iocs16_1_1 [get_bd_ports iocs16_1] [get_bd_pins axi_isa_1/iocs16]
  connect_bd_net -net irq5_0_1 [get_bd_ports irq5] [get_bd_pins axi_isa_0/irq5]
  connect_bd_net -net irq5_1_1 [get_bd_ports irq5_1] [get_bd_pins axi_isa_1/irq5]
  connect_bd_net -net isa_sd_in_0_1 [get_bd_ports isa_sd_in] [get_bd_pins axi_isa_0/isa_sd_in]
  connect_bd_net -net isa_sd_in_1_1 [get_bd_ports isa_sd_in_1] [get_bd_pins axi_isa_1/isa_sd_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_isa_0/s00_axi_aclk] [get_bd_pins axi_isa_1/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph_1/ACLK] [get_bd_pins ps7_0_axi_periph_1/M00_ACLK] [get_bd_pins ps7_0_axi_periph_1/M01_ACLK] [get_bd_pins ps7_0_axi_periph_1/S00_ACLK] [get_bd_pins rst_ps_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_isa_0/s00_axi_aresetn] [get_bd_pins axi_isa_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph_1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_1/S00_ARESETN] [get_bd_pins rst_ps_0_50M/peripheral_aresetn]
  connect_bd_net -net rst_ps_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph_1/ARESETN] [get_bd_pins rst_ps_0_50M/interconnect_aresetn]
